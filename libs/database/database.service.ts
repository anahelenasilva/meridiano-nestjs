...
// DatabaseService, so importing ConfigService here creates a circular import
// (Nest resolves the constructor param as `Object` and DI fails). Mirrors the
// same constraint in typeorm.config.ts.
@Injectable()
