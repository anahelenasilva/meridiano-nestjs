...
| `youtube-transcriptions/` | YouTube transcript extraction and processing |
| `youtube-channels/` | Channel configuration management |
| `users/` | User management |
| `bookmarks/` | Article bookmarking |
| `audio-files/` | Audio file management and generation |
...
| `/api/articles` | CRUD, search, upload, process |
| `/api/briefings` | List, get, stats |
| `/api/youtube-transcriptions` | List, get, process video |
| `/api/youtube-channels` | Create channel |
| `/api/bookmarks` | CRUD, check, count |
| `/api/audio-files` | Generate audio |
